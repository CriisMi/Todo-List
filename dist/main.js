...
const todayFormated = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'yyyy-MM-dd').toString();
...
const renderNewProject = () => {
    ...
    let newProject = (0,_projects__WEBPACK_IMPORTED_MODULE_1__.Project)();
    _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.addProject(newProject);
...
const newGroupTab = (project) => {
    ...
    addButton.addEventListener('click', function() {
        let newTask = (0,_projects__WEBPACK_IMPORTED_MODULE_1__.Task)('New Task', todayFormated, 'low');
...
const renderProject = (project) => {
    let projectIndex = _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getProjectsList().indexOf(project);
...
const Project = () => {
    ...
    const rearrangeTasks = function() {
       tasks.sort((a, b) => (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(a.getDueDate()), (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(b.getDueDate())));
    }
